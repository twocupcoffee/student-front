...
<template>
  <div class="">
    ...
    <el-dialog title="编辑学生信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-input v-show="false" v-model="form.index" autocomplete="off" />
        ...
        <el-form-item label="年级" :label-width="formLabelWidth">
          <el-select v-model="formGrade" placeholder="请选择年级">
            <el-option v-for="(item, i) in gradeList" :label="item" :value="item/" /></el-select>
        </el-form-item>
        <el-form-item v-show="clazzVisible" label="班级" :label-width="formLabelWidth">
          <el-select v-model="form.clazz" placeholder="请选择班级">
            <el-option v-for="(item, i) in clazzList" :label="item" :value="item/" /></el-select>
        </el-form-item>
